...
class MyBinaryTree {
    ...
    public MyBinaryTree(int value) { // Пустое дерево
        rootNode = null;
        add(value);
    }
    ...
    public Boolean contains(int value) { // поиск узла по значению
        ...
        while (currentNode.getValue() != value) { // поиск покуда не будет найден элемент или не будут перебраны все
            ...
            if (currentNode == null) { // если потомка нет,
                return Boolean.FALSE; // возвращаем null
            }
        }
        return  Boolean.TRUE; // возвращаем найденный элемент
    }

    public void add(int value) { // метод вставки нового элемента
    ...
    public boolean delete(int value) // Удаление узла с заданным ключом
    {
    ...
    public void traverse (Node root){ // Each child of a tree is a root of its subtree.
        ...
        this.list.addAll(Collections.singleton(root.getValue()));
    ...
    public void printSize(){
        int size = size();
        System.out.println("Количество элементов в дереве : " + size);
    }
}
